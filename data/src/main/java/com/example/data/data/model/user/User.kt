...
fun UserEntity.asUser(): User = User(
    id = id,
...
fun UserRemoteModel.asUserEntity(): UserEntity = UserEntity(
    id = id,
    firstName = name.first,
    lastName = name.last,
    email = email,
...
fun UserRemoteModel.asUser(): User = User(
    id = id,
    name = name.asName(),
    email = email,
    photoUrl = photoUrl,
...
fun User.asRemote(): UserRemoteModel = UserRemoteModel(
    id = id,
